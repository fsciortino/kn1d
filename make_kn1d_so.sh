...
# similar to above, using "module load defaults idl". This gives segfault.
   gfortran fast_b2val.f b2val.f xerror.f i1mach.f fdump.f -shared -o fast_b2val.so -fPIC -ff2c -w
   gfortran call_b2ink.f b2ink.f xerror.f i1mach.f fdump.f -shared -o call_b2ink.so -fPIC -ff2c -w
